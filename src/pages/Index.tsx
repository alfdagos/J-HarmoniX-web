  ...
  return (
    <div className="min-h-screen bg-gradient-dark">
      ...
      <header role="banner">
        ...
        >
          <div className="flex items-center justify-between px-6 py-3 max-w-5xl mx-auto">
            <a
              href="#"
              aria-label="J-HarmoniX – torna all'inizio"
              className="font-display font-bold text-lg text-foreground shrink-0"
            >
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                ...
                aria-label="J-HarmoniX su GitHub – visualizza sorgente e scarica"
      ...
      <main id="main-content" role="main">
        ...
        >
          ...
          <div className="relative max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <h1
                id="hero-heading"
                className="text-5xl md:text-7xl font-display font-black text-foreground mb-6 leading-tight whitespace-nowrap"
              >
                J-Harmon<span className="text-gradient-gold">iX</span>
              </h1>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Scarica J-HarmoniX da GitHub – Jazz Harmony Generator CLI open source"
        ...
        {/* ── KEY TAKEAWAYS (AI + Featured Snippet) ── */}
        <KeyTakeaways />
